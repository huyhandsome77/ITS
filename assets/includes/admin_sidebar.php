...
<aside id="sidebar"
    ...
    <nav class="space-y-3">
        ...
        <!-- Management Section -->
        <div class="px-4 mb-2">
            <span class="sidebar-text text-xs text-white text-opacity-60 font-semibold uppercase tracking-wider transition-opacity duration-300">Quản lý</span>
        </div>
        ...
        <!-- Reports & Analytics -->
        <div class="px-4 mb-2">
            <span class="sidebar-text text-xs text-white text-opacity-60 font-semibold uppercase tracking-wider transition-opacity duration-300">Báo cáo</span>
        </div>
