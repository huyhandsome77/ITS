...
<body class="min-h-full font-[Inter]">
            ...
            <main class="flex-1 overflow-auto p-4 md:p-6 lg:p-8" style="margin-top:76px">
                    ...
                    <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl shadow-lg p-6 text-white">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <h3 class="text-3xl font-bold mt-1">127</h3>
                            </div>
                            <div class="bg-white bg-opacity-20 p-3 rounded-lg">
                                <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
                ...
                <section class="bg-white rounded-2xl shadow-sm border p-5 mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <select id="filterStationType" class="border rounded-lg px-4 py-2">
                            <option value="">Tất cả loại trạm</option>
                            <option value="pickup">Trạm đặt</option>
                            <option value="return">Trạm trả</option>
                        </select>
                ...
                <section class="bg-white rounded-2xl shadow-sm border p-5">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <span class="text-gray-600">Tổng số: <strong id="totalOrders">28</strong> đơn</span>
                    </div>
                        ...
                        <table class="w-full">
                            <thead class="bg-gray-50 border-b">
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-left text-sm font-semibold text-gray-700">Trạm đặt</th>
                                    <th class="px-4 py-3 text-left text-sm font-semibold text-gray-700">Trạm trả</th>
                            ...
                            <tbody id="orderTableBody" class="divide-y">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-3 text-sm">
                                        <div>08/01/2026 - 10/01/2026</div>
                                        <div class="text-xs text-gray-500">3 ngày</div>
                                    </td>
                                    <td class="px-4 py-3 text-sm">Nguyễn Huệ</td>
                                    <td class="px-4 py-3 text-sm">Bến Thành</td>
                                    <td class="px-4 py-3 text-sm font-semibold text-green-600">3,600,000đ</td>
                                    <td class="px-4 py-3">
                                    ...
                                    <td class="px-4 py-3 text-center">
                                        <button class="text-blue-600 hover:text-blue-800 mx-1" title="Xem chi tiết" onclick="viewOrderDetail('#DH001')">
                                            <svg class="w-5 h-5 inline-block" fill="currentColor" viewBox="0 0 20 20">
                                                <path d="M10 12a2 2 0 100-4 2 2 0 000 4z"/>
                                                <path fill-rule="evenodd" d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clip-rule="evenodd"/>
                                            </svg>
                                        </button>
                                        <button class="text-green-600 hover:text-green-800 mx-1" title="Xác nhận" onclick="confirmPickup('#DH001')">
                                            <svg class="w-5 h-5 inline-block" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                            </svg>
                                        </button>
                                        <button class="text-red-600 hover:text-red-800 mx-1" title="Hủy đơn" onclick="cancelOrder('#DH001')">
                                            <svg class="w-5 h-5 inline-block" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-3 text-sm">
                                        <div>05/01/2026 - 12/01/2026</div>
                                        <div class="text-xs text-gray-500">7 ngày</div>
                                    </td>
                                    <td class="px-4 py-3 text-sm">Nguyễn Huệ</td>
                                    <td class="px-4 py-3 text-sm">Nguyễn Huệ</td>
                                    <td class="px-4 py-3 text-sm font-semibold text-green-600">10,500,000đ</td>
                                    <td class="px-4 py-3">
                                    ...
                                    <td class="px-4 py-3 text-center">
                                        <button class="text-blue-600 hover:text-blue-800 mx-1" title="Xem chi tiết" onclick="viewOrderDetail('#DH002')">
                                            <svg class="w-5 h-5 inline-block" fill="currentColor" viewBox="0 0 20 20">
                                                <path d="M10 12a2 2 0 100-4 2 2 0 000 4z"/>
                                                <path fill-rule="evenodd" d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clip-rule="evenodd"/>
                                            </svg>
                                        </button>
                                        <button class="text-purple-600 hover:text-purple-800 mx-1" title="Xác nhận trả xe" onclick="confirmReturn('#DH002')">
                                            <svg class="w-5 h-5 inline-block" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-3 text-sm">
                                        <div>01/01/2026 - 03/01/2026</div>
                                        <div class="text-xs text-gray-500">2 ngày</div>
                                    </td>
                                    <td class="px-4 py-3 text-sm">Bến Thành</td>
                                    <td class="px-4 py-3 text-sm">Nguyễn Huệ</td>
                                    <td class="px-4 py-3 text-sm font-semibold text-green-600">2,800,000đ</td>
                                    <td class="px-4 py-3">
                                    ...
                                    <td class="px-4 py-3 text-center">
                                        <button class="text-blue-600 hover:text-blue-800 mx-1" title="Xem chi tiết" onclick="viewOrderDetail('#DH003')">
                                            <svg class="w-5 h-5 inline-block" fill="currentColor" viewBox="0 0 20 20">
                                                <path d="M10 12a2 2 0 100-4 2 2 0 000 4z"/>
                                                <path fill-rule="evenodd" d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clip-rule="evenodd"/>
                                            </svg>
                    ...
                    <div class="flex justify-between items-center mt-4">
                        <span class="text-sm text-gray-600">Hiển thị 1-3 của 28 đơn</span>
    ...
    <script>
        ...
        document.getElementById('orderForm').addEventListener('submit', (e) => {
            e.preventDefault();
            alert('Chức năng tạo đơn sẽ được triển khai ở backend!');
            orderModal.classList.add('hidden');
        });
        ...
        function confirmPickup(orderId) {
            if (confirm('Xác nhận khách đã nhận xe?')) {
                alert('Chức năng xác nhận nhận xe sẽ được triển khai ở backend!');
            }
        }

        function confirmReturn(orderId) {
            if (confirm('Xác nhận khách đã trả xe?')) {
                alert('Chức năng xác nhận trả xe sẽ được triển khai ở backend!');
            }
        }

        function cancelOrder(orderId) {
            if (confirm('Bạn có chắc muốn hủy đơn này?')) {
                alert('Chức năng hủy đơn sẽ được triển khai ở backend!');
            }
        }
    </script>
</body>
