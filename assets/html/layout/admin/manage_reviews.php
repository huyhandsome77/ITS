            ...
            <main class="flex-1 overflow-auto p-4 md:p-6 lg:p-8" style="margin-top:76px">
                ...
                <section class="bg-white rounded-2xl shadow-sm border p-5 mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                        <select id="filterRating" class="border rounded-lg px-4 py-2">
                ...
                <section class="bg-white rounded-2xl shadow-sm border p-5">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="border rounded-lg p-5 hover:shadow-md transition">
                            <div class="flex justify-between items-start mb-3">
                                <div class="flex items-start space-x-4">
                                    <div class="w-12 h-12 bg-blue-500 text-white rounded-full flex items-center justify-center font-semibold text-lg">NA</div>
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600 mt-1">Đánh giá xe: <span class="font-semibold">Toyota Camry (51G-12345)</span></p>
                                    </div>
                                </div>
                            ...
                            <div class="ml-16">
                                <p class="text-gray-700 mb-3">Xe rất mới và sạch sẽ. Lái êm, tiết kiệm xăng. Nhân viên trạm nhiệt tình, giao xe đúng giờ. Sẽ thuê lại lần sau!</p>
                                <div class="flex space-x-2 mt-3">
                                    <button class="px-4 py-2 text-sm border rounded-lg hover:bg-gray-50" onclick="viewReview(1)">
                                    ...
                                    <button class="px-4 py-2 text-sm border rounded-lg hover:bg-gray-50 text-yellow-600" onclick="hideReview(1)">
                                        <svg class="w-4 h-4 inline-block mr-1" fill="currentColor" viewBox="0 0 20 20">
                                    ...
                                    <button class="px-4 py-2 text-sm border rounded-lg hover:bg-gray-50 text-red-600" onclick="deleteReview(1)">
                                        <svg class="w-4 h-4 inline-block mr-1" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div class="border rounded-lg p-5 hover:shadow-md transition bg-blue-50">
                            <div class="flex justify-between items-start mb-3">
                                <div class="flex items-start space-x-4">
                                    <div class="w-12 h-12 bg-purple-500 text-white rounded-full flex items-center justify-center font-semibold text-lg">TB</div>
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600 mt-1">Đánh giá trạm: <span class="font-semibold">Trạm Nguyễn Huệ</span></p>
                                    </div>
                                </div>
                                <div class="flex items-center space-x-2">
                            ...
                            <div class="ml-16">
                                <p class="text-gray-700 mb-3">Trạm sạch sẽ, tiện lợi. Thủ tục nhanh gọn. Tuy nhiên bãi đỗ hơi nhỏ vào giờ cao điểm.</p>
                                <div class="flex space-x-2 mt-3">
                                    <button class="px-4 py-2 text-sm bg-green-600 text-white rounded-lg hover:bg-green-700" onclick="approveReview(2)">
                                        <svg class="w-4 h-4 inline-block mr-1" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                        </svg>
                                        Duyệt
                                    </button>
                                    <button class="px-4 py-2 text-sm border rounded-lg hover:bg-gray-50" onclick="viewReview(2)">Chi tiết</button>
                                    <button class="px-4 py-2 text-sm border rounded-lg hover:bg-gray-50 text-red-600" onclick="rejectReview(2)">
                                        <svg class="w-4 h-4 inline-block mr-1" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div class="border-2 border-red-300 rounded-lg p-5 hover:shadow-md transition bg-red-50">
                            <div class="flex justify-between items-start mb-3">
                                <div class="flex items-start space-x-4">
                                    <div class="w-12 h-12 bg-gray-500 text-white rounded-full flex items-center justify-center font-semibold text-lg">NP</div>
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600 mt-1">Đánh giá xe: <span class="font-semibold">Honda CR-V (51H-67890)</span></p>
                                    </div>
                                </div>
                                <div class="flex items-center space-x-2">
                            ...
                            <div class="ml-16">
                                <p class="text-gray-700 mb-2">Xe như cứt, nhân viên thái độ, lừa đảo khách hàng, web lag vãi l. Không đáng tin cậy!!!</p>
                                <div class="bg-red-100 border border-red-300 rounded-lg p-3 mb-3">
                                    <p class="text-sm font-semibold text-red-800">⚠️ Lý do báo cáo: Ngôn từ xúc phạm, không có cơ sở</p>
                                </div>
                                <div class="flex space-x-2 mt-3">
                                    <button class="px-4 py-2 text-sm border rounded-lg hover:bg-gray-50" onclick="viewReview(3)">Chi tiết</button>
                                    <button class="px-4 py-2 text-sm bg-yellow-600 text-white rounded-lg hover:bg-yellow-700">
                                        <svg class="w-4 h-4 inline-block mr-1" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                                        </svg>
                                        Xem xét báo cáo
                                    </button>
                                    <button class="px-4 py-2 text-sm bg-red-600 text-white rounded-lg hover:bg-red-700" onclick="deleteReview(3)">
                                        Xóa vĩnh viễn
                                    </button>
                                </div>
                            </div>
