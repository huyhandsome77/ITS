...
<head>
    ...
    <title>Đăng ký | Thuexe.com</title>
    ...
    <div class="w-full max-w-2xl">
        ...
        <div>
            ...
            <div class="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-6 md:p-8 lg:p-10 animate-fadeInUp"
                ...
                <form id="signupForm" method="POST" action="../../php/auth/signup_process.php" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="fullname" name="fullname" required
                                ...
                                style="focus:border-color: var(--primary-color); focus:ring-color: var(--primary-light);"
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-xs text-gray-500">Mật khẩu tối thiểu 8 ký tự, bao gồm chữ hoa, chữ thường và
                            số</p>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <label for="terms" class="ml-2 text-sm text-gray-600">
                            Tôi đồng ý với <a href="#" class="font-semibold hover:underline"
                                style="color: var(--primary-color);">Điều khoản dịch vụ</a>
                            và <a href="#" class="font-semibold hover:underline"
                                style="color: var(--primary-color);">Chính sách bảo mật</a>
                        </label>
                    </div>
                    ...
                    <div class="text-center mt-6">
                        <p class="text-sm text-gray-600">
                            Đã có tài khoản?
                            <a href="login.php" class="font-bold hover:underline" style="color: var(--primary-color);">
                                Đăng nhập ngay
                            </a>
                        </p>
                    </div>
